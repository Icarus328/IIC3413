...
public:
  ...
  explicit IIC3413DBException(const std::string& msg)
      : msg(msg) {}
...
public:
  explicit QueryParsingException(const std::string& msg)
      : IIC3413DBException(msg) {}
};
...
class AbortException : public IIC3413DBException {
public:
  explicit AbortException(const std::string& msg)
      : IIC3413DBException(msg) {}
};

// Exceptions related to the lock manager (deadlock, timeout, etc.)
class LockException : public IIC3413DBException {
public:
  explicit LockException(const std::string& msg)
      : IIC3413DBException(msg) {}
};
