...
private:
  ...
  virtual std::any visitCreateTable(IIC3413DBParser::CreateTableContext*) override;

  virtual std::any visitCreateIndex(IIC3413DBParser::CreateIndexContext*) override;
