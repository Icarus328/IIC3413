...
public:
   ...
   */
    ...
    virtual std::any visitCreateTable(IIC3413DBParser::CreateTableContext *context) = 0;

    virtual std::any visitCreateIndex(IIC3413DBParser::CreateIndexContext *context) = 0;
