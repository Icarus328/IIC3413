...
public:
  ...
  virtual std::any visitCreateTable(IIC3413DBParser::CreateTableContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitCreateIndex(IIC3413DBParser::CreateIndexContext *ctx) override {
    return visitChildren(ctx);
  }
