...
#include "query/executor/index_creation.h"
...
void Optimizer::visit(IndexCreationPlan& index) {
  current_action = std::make_unique<IndexCreation>(index.table_name, index.column_name, tx_id);
}
