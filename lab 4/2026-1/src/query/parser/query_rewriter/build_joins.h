...
#include "query/parser/logical_plan/full_outer_join_plan.h"
...
public:
  ...
  void visit(CartesianProductPlan& cartesian_product) override {
    ...
    while (!children.empty()) {
      ...
      auto* first_full_outer_join = dynamic_cast<FullOuterJoinPlan*>(children[0].get());
      ...
      } else if (first_full_outer_join != nullptr) {
        first_alias = first_full_outer_join->alias;
      } else {
