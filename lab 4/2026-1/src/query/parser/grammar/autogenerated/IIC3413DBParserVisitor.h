...
public:
   ...
   */
    ...
    virtual std::any visitUpdateQuery(IIC3413DBParser::UpdateQueryContext *context) = 0;

    virtual std::any visitDeleteQuery(IIC3413DBParser::DeleteQueryContext *context) = 0;
    ...
    virtual std::any visitFullOuterJoin(IIC3413DBParser::FullOuterJoinContext *context) = 0;
    ...
    virtual std::any visitAdditiveExpr(IIC3413DBParser::AdditiveExprContext *context) = 0;

    virtual std::any visitMultiplicativeExpr(IIC3413DBParser::MultiplicativeExprContext *context) = 0;

    virtual std::any visitUnaryExpr(IIC3413DBParser::UnaryExprContext *context) = 0;

    virtual std::any visitAtomicExpr(IIC3413DBParser::AtomicExprContext *context) = 0;

    virtual std::any visitAssignmentList(IIC3413DBParser::AssignmentListContext *context) = 0;

    virtual std::any visitAssignment(IIC3413DBParser::AssignmentContext *context) = 0;
