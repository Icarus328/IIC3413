...
public:
  ...
  virtual std::any visitUpdateQuery(IIC3413DBParser::UpdateQueryContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitDeleteQuery(IIC3413DBParser::DeleteQueryContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitFullOuterJoin(IIC3413DBParser::FullOuterJoinContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitAdditiveExpr(IIC3413DBParser::AdditiveExprContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitMultiplicativeExpr(IIC3413DBParser::MultiplicativeExprContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitUnaryExpr(IIC3413DBParser::UnaryExprContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAtomicExpr(IIC3413DBParser::AtomicExprContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAssignmentList(IIC3413DBParser::AssignmentListContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAssignment(IIC3413DBParser::AssignmentContext *ctx) override {
    return visitChildren(ctx);
  }
